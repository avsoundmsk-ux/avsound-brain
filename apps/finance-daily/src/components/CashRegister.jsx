...
export default function CashRegister({
  ...
  // Аренда / гаражи — только касса, не режут зарплату дня
  ...
  // расходы уже содержат помещенияРасх; автоАренду вычитаем отдельно
  const расчётный = остатокВчера + реализация + работа + приходОзон + приходЯндекс
                  - расходы - зарплата - закупка - возвраты - вычет - автоАренда
